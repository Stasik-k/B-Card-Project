...
const CreateCard: React.FC = () => {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <form
        className="flex flex-col w-2/5 w-full max-w-4xl gap-4 p-4 p-12 m-auto mb-10 text-black bg-white bg-gray-200 rounded-lg shadow-lg mt-14 dark:bg-gray-800 dark:text-white "
        onSubmit={handleSubmit} style={{ maxWidth: '600px', margin: 'auto' }}>
